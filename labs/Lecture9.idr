...
a data structure for (finite) sets

Recall - sets are collections of elements (of some type), e.g. {0,2,1,3} : Set Nat
...
-- an implementation of a data structure for sets
